 ...
 * @param {number} monthNum - The month number (1 = January).
 * @returns {string} Three-letter abbreviation (ex. 'Jan', 'Feb').
 */
const monthToAbbreviation = (monthNum) => monthsAbbreviations[monthNum - 1] ?? String(monthNum);
